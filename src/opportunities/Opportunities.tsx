...
const ApplyButton = () => {
    const style = "flex items-center p-8 h-10 relative font-bold text-center rounded-lg bg-black text-white ring-1 ring-dark-primary ring-inset hover:text-black hover:bg-dark-primary";
...
const BackgroundRoles = () => {
    return (
        <>
            <span className="animate-jump-in animate-delay-[350ms] absolute top-[18%] left-[20%] opacity-40 text-lg md:text-2xl lg:text-4xl text-[#5DEF97]">marketing</span>
            <span className="animate-jump-in animate-delay-[550ms] absolute top-[22%] left-[35%] opacity-40 text-lg md:text-2xl lg:text-4xl text-[#EE9BE6]">software dev</span>
            <span className="animate-jump-in animate-delay-[650ms] absolute top-[17%] left-[55%] opacity-40 text-lg md:text-2xl lg:text-4xl text-[#887FF2]">corporate relations</span>
            <span className="animate-jump-in animate-delay-[750ms] absolute top-[60%] left-[24%] opacity-40 text-lg md:text-2xl lg:text-4xl text-[#9BDAEE]">workshops</span>
            <span className="animate-jump-in animate-delay-[950ms] absolute top-[55%] left-[42%] opacity-40 text-lg md:text-2xl lg:text-4xl text-[#ECEE9B]">competitions</span>
            <span className="animate-jump-in animate-delay-[850ms] absolute top-[57%] left-[62%] opacity-40 text-lg md:text-2xl lg:text-4xl text-[#EE9B9B]">teams</span>
        </>
    )
}
