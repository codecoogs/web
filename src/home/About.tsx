...
import { aboutUsDesc, socialsDesc, teamsDesc, competitionsDesc, workshopsDesc, officers, sponsors, partners } from "../data/about";
...
const OfficerCard = (props: OfficerCardProps) => {
  ...
  if (!image) {
    const folderName = officers[props.semester].semester.split(" ").reverse().join("").toLowerCase();
      ...
      <div className="flex text-lg justify-center items-center space-x-4 my-8">
        <div className="flex-1 relative">
          <div className="relative flex justify-end">
            ...
            <span className={"text-dark-primary opacity-100 z-10"}>{officers[semester].semester}</span>
            <span
...
const About = () => {
  return (
    <div className="text-white p-4">
                    ...
                    return (
                      <div key={partner.name} className="p-4">
                        <a href={partner.link} target="_blank" rel="noreferrer">
                          <img className="" src={partner.logo} alt={partner.name} width={70} height={70} />
                        </a>
                      </div>
                    );
                  })}
        ...
        <AboutSection id="us">
          ...
          <div className="grid grid-cols-1 gap-4">
            <div className="p-8 rounded-lg ring-0 ring-inset ring-white/[.3] flex flex-col md:flex-row items-center">
              <div className="w-56 h-36 flex-shrink-0 md:border-r-2 border-white/[.8]">
                <FadeInSection className={"animate-fade-right animate-once animate-duration-[1700ms]"}>
                  <img className="w-36 h-full mx-auto md:mr-5" src={"/assets/socials-coco.webp"} alt="Socials CoCo" />
                </FadeInSection>
              </div>
            ...
            <div className="p-8 rounded-lg ring-0 ring-inset ring-white/[.3] flex flex-col md:flex-row items-center">
              <div className="w-56 h-36 flex-shrink-0 md:border-r-2 border-white/[.8]">
                <FadeInSection className={"animate-fade-right animate-once animate-duration-[1700ms]"}>
                  <img className="w-48 h-full mx-auto md:mr-2" src={"/assets/teams-coco.webp"} alt="Teams CoCo" />
                </FadeInSection>
              </div>
              <div className="flex-1 ml-4 pt-2 border-t-2 md:pt-0 md:border-t-0">
                <FadeInSection className={"animate-fade-left animate-once animate-duration-[1700ms]"}>
            ...
            <div className="p-8 rounded-lg ring-0 ring-inset ring-white/[.3] flex flex-col md:flex-row items-center">
              <div className="w-56 h-36 flex-shrink-0 md:border-r-2 border-white/[.8]">
                <FadeInSection className={"animate-fade-right animate-once animate-duration-[1700ms]"}>
                  <img className="w-full h-full mx-auto md:mr-0" src={"/assets/competitions-coco.webp"} alt="Competitions CoCo" />
                </FadeInSection>
              </div>
              <div className="flex-1 ml-4 pt-2 border-t-2 md:pt-0 md:border-t-0">
                <FadeInSection className={"animate-fade-left animate-once animate-duration-[1700ms]"}>
            ...
            <div className="p-8 rounded-lg ring-0 ring-inset ring-white/[.3] flex flex-col md:flex-row items-center">
              <div className="w-56 h-36 flex-shrink-0 md:border-r-2 border-white/[.8]">
                <FadeInSection className={"animate-fade-right animate-once animate-duration-[1700ms]"}>
                  <img className="w-36 h-full mx-auto md:mr-0" src={"/assets/workshops-coco.webp"} alt="Workshops CoCo" />
                </FadeInSection>
              </div>
              <div className="flex-1 ml-4 pt-2 border-t-2 md:pt-0 md:border-t-0">
                <FadeInSection className={"animate-fade-left animate-once animate-duration-[1700ms]"}>
            ...
            <div className="flex flex-col items-center justify-center mb-10">
              <FadeInSection className={"animate-fade-right animate-once animate-duration-[1700ms]"}>
                <p className="text-sm opacity-70">Check all of our available resources for Workshops, Competitions, etc</p>
              </FadeInSection>
              <FadeInSection className={"animate-fade-left animate-once animate-duration-[1700ms]"}>
                <Link
      ...
      <FadeInSection className={"animate-fade-up animate-once animate-duration-[1700ms]"}>
        <OfficerSection />
      </FadeInSection>
    </div>
  );
