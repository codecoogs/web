...
const AboutUsButton = () => {
	const style =
		"flex items-center p-6 h-10 relative font-bold text-center rounded-lg bg-transparent text-white hover:text-dark-primary";
...
const JoinUsButton = () => {
	const style =
		"flex items-center p-6 h-10 relative font-bold text-center rounded-lg bg-black text-white ring-1 ring-dark-primary ring-inset hover:text-black hover:bg-dark-primary";
			...
			<div className="relative flex flex-col justify-center min-h-screen">
				...
				<div className="my-4 mx-auto md:w-1/2 text-center animate-fade-up animate-duration-[1500ms]">
					<span className="text-base text-white">
						Build projects and compete with teams; we enhance your coding skills
						in a collaborative environment, unlocking the potential for
